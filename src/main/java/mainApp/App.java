...
public class App {
    ...
    private static void browse(BookmarkContainer container, IO io) {
        while (true) {
            ...
            String command = io.nextLine("Type \"next\" to see the next bookmark, \"show\" to show more information on the current one, \"edit\" to edit the current one, \"ser\" to test bookmark serialization or \"exit\" to stop browsing bookmarks.");
